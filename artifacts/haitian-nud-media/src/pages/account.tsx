...
import { useGetMe, useGetMySubscription, useListMyTickets, useCreateTicket, getListMyTicketsQueryKey } from "@workspace/api-client-react";
...
export function Account() {
  ...
  const { data: me, isLoading: isLoadingMe } = useGetMe({ query: { enabled: !!isSignedIn } });
  const { data: sub, isLoading: isLoadingSub } = useGetMySubscription({ query: { enabled: !!isSignedIn } });
  const { data: tickets, isLoading: isLoadingTickets } = useListMyTickets({ query: { enabled: !!isSignedIn } });

      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="md:col-span-2">
          ...
          <p className="text-sm text-muted-foreground mb-6 max-w-sm">
            La plateforme de contenu haïtien pour adultes. Rejoins la communauté.
          </p>

          {/* Social Media Buttons — Pro Style */}
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="https://t.me/dg_haitiannud" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                Groupe 1
              </a>
            </li>
            <li>
              <a href="https://t.me/+UXtFEcF2Dw8zNGYx" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                Groupe 2
              </a>
            </li>
            <li>
              <a href="https://t.me/hatiannud_canal" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                Canal 1
              </a>
            </li>
            <li>
              <a href="https://t.me/haiti_annud" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                Canal 2
              </a>
            </li>
          </ul>
